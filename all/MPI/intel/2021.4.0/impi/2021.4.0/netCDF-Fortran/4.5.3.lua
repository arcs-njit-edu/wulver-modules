...
local root = "/apps/easybuild/software/netCDF-Fortran/4.5.3-iimpi-2021b"
...
setenv("EBDEVELNETCDFMINFORTRAN", pathJoin(root, "easybuild/MPI-intel-2021.4.0-impi-2021.4.0-netCDF-Fortran-4.5.3-easybuild-devel"))
