...
local root = "/apps/easybuild/software/HDF5/1.12.1-iimpi-2021b"
...
setenv("EBVERSIONHDF5", "1.12.1")
setenv("EBDEVELHDF5", pathJoin(root, "easybuild/MPI-intel-2021.4.0-impi-2021.4.0-HDF5-1.12.1-easybuild-devel"))

setenv("HDF5_DIR", "/apps/easybuild/software/HDF5/1.12.1-iimpi-2021b")
