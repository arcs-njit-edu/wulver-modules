...
local root = "/apps/easybuild/software/netCDF/4.8.1-iimpi-2021b"
...
setenv("EBDEVELNETCDF", pathJoin(root, "easybuild/MPI-intel-2021.4.0-impi-2021.4.0-netCDF-4.8.1-easybuild-devel"))
