...
local root = "/apps/easybuild/software/GROMACS/2021.5-foss-2021b"
...
setenv("EBDEVELGROMACS", pathJoin(root, "easybuild/MPI-GCC-11.2.0-OpenMPI-4.1.1-GROMACS-2021.5-easybuild-devel"))
