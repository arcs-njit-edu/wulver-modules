...
local root = "/apps/easybuild/software/HDF5/1.12.1-gompi-2021b"
...
setenv("EBDEVELHDF5", pathJoin(root, "easybuild/MPI-GCC-11.2.0-OpenMPI-4.1.1-HDF5-1.12.1-easybuild-devel"))

setenv("HDF5_DIR", "/apps/easybuild/software/HDF5/1.12.1-gompi-2021b")
