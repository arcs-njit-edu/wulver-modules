...
local root = "/apps/easybuild/software/ScaLAPACK/2.1.0-gompi-2021b-fb"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/MPI-GCC-11.2.0-OpenMPI-4.1.1-ScaLAPACK-2.1.0-fb-easybuild-devel"))
