...
local root = "/apps/easybuild/software/LAMMPS/23Jun2022-foss-2021b-kokkos-CUDA-11.4.1"
...
if not ( isloaded("NCCL/2.10.3-CUDA-11.4.1") ) then
    load("NCCL/2.10.3-CUDA-11.4.1")
end
...
setenv("EBDEVELLAMMPS", pathJoin(root, "easybuild/MPI-GCC-11.2.0-OpenMPI-4.1.1-LAMMPS-23Jun2022-kokkos-CUDA-11.4.1-easybuild-devel"))
