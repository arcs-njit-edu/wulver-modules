...
local root = "/apps/easybuild/software/FFTW.MPI/3.3.10-gompi-2022b"
...
setenv("EBDEVELFFTWMPI", pathJoin(root, "easybuild/MPI-GCC-12.2.0-OpenMPI-4.1.4-FFTW.MPI-3.3.10-easybuild-devel"))
