...
local root = "/apps/easybuild/software/netCDF-Fortran/4.6.0-gompi-2022b"
...
setenv("EBVERSIONNETCDFMINFORTRAN", "4.6.0")
setenv("EBDEVELNETCDFMINFORTRAN", pathJoin(root, "easybuild/MPI-GCC-12.2.0-OpenMPI-4.1.4-netCDF-Fortran-4.6.0-easybuild-devel"))
