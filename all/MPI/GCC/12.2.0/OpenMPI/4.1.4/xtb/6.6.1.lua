...
local root = "/apps/easybuild/software/xtb/6.6.1-foss-2022b"
...
setenv("EBDEVELXTB", pathJoin(root, "easybuild/MPI-GCC-12.2.0-OpenMPI-4.1.4-xtb-6.6.1-easybuild-devel"))

setenv("XTBHOME", "/apps/easybuild/software/xtb/6.6.1-foss-2022b")
setenv("XTBPATH", "/apps/easybuild/software/xtb/6.6.1-foss-2022b")
