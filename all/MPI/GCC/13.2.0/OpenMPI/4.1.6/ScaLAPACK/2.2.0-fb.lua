...
local root = "/apps/easybuild/software/ScaLAPACK/2.2.0-gompi-2023b-fb"
...
setenv("EBDEVELSCALAPACK", pathJoin(root, "easybuild/MPI-GCC-13.2.0-OpenMPI-4.1.6-ScaLAPACK-2.2.0-fb-easybuild-devel"))
