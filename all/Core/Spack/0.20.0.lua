...
local root = "/apps/easybuild/software/Spack/0.20.0"
...
setenv("EBVERSIONSPACK", "0.20.0")
setenv("EBDEVELSPACK", pathJoin(root, "easybuild/Core-Spack-0.20.0-easybuild-devel"))
