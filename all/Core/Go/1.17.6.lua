...
local root = "/apps/easybuild/software/Go/1.17.6"

conflict("Go")
prepend_path("MODULEPATH", "/apps/easybuild/modules/all/Compiler/Go/1.17.6")
...
setenv("GOROOT", "/apps/easybuild/software/Go/1.17.6")
