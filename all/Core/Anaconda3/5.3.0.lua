...
local root = "/apps/easybuild/software/Anaconda3/5.3.0"
...
setenv("EBVERSIONANACONDA3", "5.3.0")
setenv("EBDEVELANACONDA3", pathJoin(root, "easybuild/Core-Anaconda3-5.3.0-easybuild-devel"))
