...
local root = "/apps/easybuild/software/imkl/2021.4.0"
...
setenv("EBDEVELIMKL", pathJoin(root, "easybuild/Core-imkl-2021.4.0-easybuild-devel"))

setenv("MKL_EXAMPLES", "/apps/easybuild/software/imkl/2021.4.0/mkl/2021.4.0/examples")
setenv("MKLROOT", "/apps/easybuild/software/imkl/2021.4.0/mkl/2021.4.0")
