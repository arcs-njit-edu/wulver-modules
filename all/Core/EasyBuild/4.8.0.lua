...
local root = "/apps/easybuild/software/EasyBuild/4.8.0"
...
setenv("EBVERSIONEASYBUILD", "4.8.0")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.8.0-easybuild-devel"))
