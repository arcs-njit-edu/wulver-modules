...
local root = "/apps/easybuild/software/EasyBuild/4.8.2"
...
setenv("EBVERSIONEASYBUILD", "4.8.2")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/Core-EasyBuild-4.8.2-easybuild-devel"))
