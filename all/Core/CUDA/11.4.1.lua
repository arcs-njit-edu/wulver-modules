...
local root = "/apps/easybuild/software/CUDA/11.4.1"
...
setenv("EBVERSIONCUDA", "11.4.1")
setenv("EBDEVELCUDA", pathJoin(root, "easybuild/Core-CUDA-11.4.1-easybuild-devel"))

setenv("CUDA_HOME", "/apps/easybuild/software/CUDA/11.4.1")
setenv("CUDA_ROOT", "/apps/easybuild/software/CUDA/11.4.1")
setenv("CUDA_PATH", "/apps/easybuild/software/CUDA/11.4.1")
