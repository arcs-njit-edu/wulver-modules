...
local root = "/apps/easybuild/software/FlexiBLAS/3.0.4-GCC-11.2.0"

conflict("FlexiBLAS")

if not ( isloaded("OpenBLAS/0.3.18") ) then
    load("OpenBLAS/0.3.18")
end
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "easybuild/Compiler-GCC-11.2.0-FlexiBLAS-3.0.4-easybuild-devel"))
