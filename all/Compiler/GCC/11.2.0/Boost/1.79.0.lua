...
local root = "/apps/easybuild/software/Boost/1.79.0-GCC-11.2.0"
...
setenv("EBDEVELBOOST", pathJoin(root, "easybuild/Compiler-GCC-11.2.0-Boost-1.79.0-easybuild-devel"))

setenv("BOOST_ROOT", "/apps/easybuild/software/Boost/1.79.0-GCC-11.2.0")
