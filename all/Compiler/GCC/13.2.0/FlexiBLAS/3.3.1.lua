...
local root = "/apps/easybuild/software/FlexiBLAS/3.3.1-GCC-13.2.0"

conflict("FlexiBLAS")

if not ( isloaded("OpenBLAS/0.3.24") ) then
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "easybuild/Compiler-GCC-13.2.0-FlexiBLAS-3.3.1-easybuild-devel"))
