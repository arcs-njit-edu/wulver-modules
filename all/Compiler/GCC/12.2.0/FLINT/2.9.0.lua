...
local root = "/apps/easybuild/software/FLINT/2.9.0-gfbf-2022b"
...
setenv("EBVERSIONFLINT", "2.9.0")
setenv("EBDEVELFLINT", pathJoin(root, "easybuild/Compiler-GCC-12.2.0-FLINT-2.9.0-easybuild-devel"))
