...
local root = "/apps/easybuild/software/GEOS/3.11.1-GCC-12.2.0"
...
setenv("EBVERSIONGEOS", "3.11.1")
setenv("EBDEVELGEOS", pathJoin(root, "easybuild/Compiler-GCC-12.2.0-GEOS-3.11.1-easybuild-devel"))
