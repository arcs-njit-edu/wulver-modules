...
local root = "/apps/easybuild/software/libarchive/3.6.1-GCCcore-12.2.0"
...
setenv("EBDEVELLIBARCHIVE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libarchive-3.6.1-easybuild-devel"))
