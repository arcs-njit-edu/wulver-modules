...
local root = "/apps/easybuild/software/libreadline/8.2-GCCcore-12.2.0"
...
setenv("EBDEVELLIBREADLINE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libreadline-8.2-easybuild-devel"))
