...
local root = "/apps/easybuild/software/Bison/3.8.2-GCCcore-12.2.0"
...
setenv("EBDEVELBISON", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Bison-3.8.2-easybuild-devel"))
