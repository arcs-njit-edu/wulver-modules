...
local root = "/apps/easybuild/software/ZeroMQ/4.3.4-GCCcore-12.2.0"
...
setenv("EBDEVELZEROMQ", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-ZeroMQ-4.3.4-easybuild-devel"))
