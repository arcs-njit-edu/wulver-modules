...
local root = "/apps/easybuild/software/FLAC/1.4.2-GCCcore-12.2.0"
...
setenv("EBVERSIONFLAC", "1.4.2")
setenv("EBDEVELFLAC", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-FLAC-1.4.2-easybuild-devel"))
