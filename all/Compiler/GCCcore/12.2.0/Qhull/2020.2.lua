...
local root = "/apps/easybuild/software/Qhull/2020.2-GCCcore-12.2.0"
...
setenv("EBDEVELQHULL", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Qhull-2020.2-easybuild-devel"))
