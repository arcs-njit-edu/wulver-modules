...
local root = "/apps/easybuild/software/gzip/1.12-GCCcore-12.2.0"
...
setenv("EBDEVELGZIP", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-gzip-1.12-easybuild-devel"))
