...
local root = "/apps/easybuild/software/HDF/4.2.15-GCCcore-12.2.0"
...
setenv("EBDEVELHDF", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-HDF-4.2.15-easybuild-devel"))
