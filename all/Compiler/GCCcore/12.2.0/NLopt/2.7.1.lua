...
local root = "/apps/easybuild/software/NLopt/2.7.1-GCCcore-12.2.0"
...
setenv("EBDEVELNLOPT", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-NLopt-2.7.1-easybuild-devel"))
