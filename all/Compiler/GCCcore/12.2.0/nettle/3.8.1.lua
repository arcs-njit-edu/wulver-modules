...
local root = "/apps/easybuild/software/nettle/3.8.1-GCCcore-12.2.0"
...
setenv("EBDEVELNETTLE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-nettle-3.8.1-easybuild-devel"))
