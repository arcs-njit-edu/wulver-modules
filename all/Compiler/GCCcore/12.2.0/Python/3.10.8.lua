...
click-8.1.3, clikit-0.6.2, cloudpickle-2.2.0, colorama-0.4.6,
commonmark-0.9.1, crashtest-0.3.1, cryptography-38.0.3, Cython-0.29.32,
decorator-5.1.1, distlib-0.3.6, docopt-0.6.2, docutils-0.19, doit-0.36.0,
dulwich-0.20.50, ecdsa-0.18.0, editables-0.3, exceptiongroup-1.0.1,
execnet-1.9.0, filelock-3.8.0, flit-3.8.0, flit_core-3.8.0, flit_scm-1.7.0,
fsspec-2022.11.0, future-0.18.2, glob2-0.7, hatch_fancy_pypi_readme-22.8.0,
hatch_vcs-0.2.0, hatchling-1.11.1, html5lib-1.1, idna-3.4, imagesize-1.4.1,
importlib_metadata-5.0.0, importlib_resources-5.10.0, iniconfig-1.1.1,
intervaltree-3.1.0, intreehooks-1.0, ipaddress-1.0.23, jaraco.classes-3.2.3,
jeepney-0.8.0, Jinja2-3.1.2, joblib-1.2.0, jsonschema-4.17.0, keyring-23.11.0,
...
core-1.3.2, poetry_plugin_export-1.2.0, pooch-1.6.0, psutil-5.9.4,
ptyprocess-0.7.0, py-1.11.0, py_expression_eval-0.3.14, pyasn1-0.4.8,
pycparser-2.21, pycryptodome-3.17, pydevtool-0.3.0, Pygments-2.13.0,
pylev-1.4.0, PyNaCl-1.5.0, pyparsing-3.0.9, pyrsistent-0.19.2, pytest-7.2.0,
pytest-xdist-3.1.0, python-dateutil-2.8.2, pytoml-0.1.21, pytz-2022.6,
regex-2022.10.31, requests-2.28.1, requests-toolbelt-0.9.1, rich-13.1.0, rich-
click-1.6.0, scandir-1.10.0, SecretStorage-3.3.3, semantic_version-2.10.0,
...
local root = "/apps/easybuild/software/Python/3.10.8-GCCcore-12.2.0"
...
setenv("EBDEVELPYTHON", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Python-3.10.8-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "easybuild/python"))
-- Built with EasyBuild version 4.7.1
setenv("EBEXTSLISTPYTHON", "wheel-0.38.4,setuptools-63.4.3,pip-22.3.1,blist-1.3.6,pbr-5.11.0,Cython-0.29.32,six-1.16.0,toml-0.10.2,flit_core-3.8.0,tomli-2.0.1,packaging-21.3,setuptools_scm-7.0.5,python-dateutil-2.8.2,decorator-5.1.1,liac-arff-2.5.0,pycryptodome-3.17,ecdsa-0.18.0,ipaddress-1.0.23,asn1crypto-1.5.1,idna-3.4,pycparser-2.21,cffi-1.15.1,semantic_version-2.10.0,typing_extensions-4.4.0,setuptools-rust-1.5.2,cryptography-38.0.3,pyasn1-0.4.8,PyNaCl-1.5.0,bcrypt-4.0.1,paramiko-2.12.0,pyparsing-3.0.9,netifaces-0.11.0,netaddr-0.8.0,mock-4.0.3,pytz-2022.6,bitstring-3.1.9,appdirs-1.4.4,distlib-0.3.6,filelock-3.8.0,zipp-3.10.0,importlib_metadata-5.0.0,backports.entry-points-selectable-1.2.0,pathspec-0.10.1,pluggy-1.0.0,editables-0.3,hatchling-1.11.1,hatch_vcs-0.2.0,platformdirs-2.5.3,scandir-1.10.0,pathlib2-2.3.7.post1,importlib_resources-5.10.0,virtualenv-20.16.6,docopt-0.6.2,joblib-1.2.0,chardet-5.0.0,certifi-2022.9.24,urllib3-1.26.12,charset-normalizer-2.1.1,requests-2.28.1,xlrd-2.0.1,py_expression_eval-0.3.14,tabulate-0.9.0,ujson-5.5.0,atomicwrites-1.4.1,py-1.11.0,more-itertools-9.0.0,attrs-22.1.0,backports.functools_lru_cache-1.6.4,wcwidth-0.2.5,iniconfig-1.1.1,colorama-0.4.6,flit_scm-1.7.0,exceptiongroup-1.0.1,pytest-7.2.0,MarkupSafe-2.1.1,Jinja2-3.1.2,sphinxcontrib-serializinghtml-1.1.5,sphinxcontrib-websupport-1.2.4,Pygments-2.13.0,imagesize-1.4.1,docutils-0.19,snowballstemmer-2.2.0,alabaster-0.7.12,sphinxcontrib-applehelp-1.0.2,sphinxcontrib-devhelp-1.0.2,sphinxcontrib-htmlhelp-2.0.0,sphinxcontrib-jsmath-1.0.1,sphinxcontrib-qthelp-1.0.3,Babel-2.11.0,Sphinx-5.3.0,sphinx-bootstrap-theme-0.8.1,click-8.1.3,psutil-5.9.4,future-0.18.2,sortedcontainers-2.4.0,intervaltree-3.1.0,pytoml-0.1.21,zipfile36-0.1.3,tomli_w-1.0.0,flit-3.8.0,regex-2022.10.31,intreehooks-1.0,pylev-1.4.0,pastel-0.2.1,crashtest-0.3.1,clikit-0.6.2,jeepney-0.8.0,SecretStorage-3.3.3,keyring-23.11.0,jaraco.classes-3.2.3,keyrings.alt-4.2.0,tomlkit-0.11.6,shellingham-1.5.0,requests-toolbelt-0.9.1,pyrsistent-0.19.2,pkginfo-1.8.3,ptyprocess-0.7.0,pexpect-4.8.0,hatch_fancy_pypi_readme-22.8.0,jsonschema-4.17.0,simplejson-3.17.6,webencodings-0.5.1,html5lib-1.1,cleo-1.0.0a5,cachy-0.3.0,msgpack-1.0.4,CacheControl-0.12.11,lockfile-0.12.2,poetry-core-1.3.2,glob2-0.7,dulwich-0.20.50,poetry_plugin_export-1.2.0,poetry-1.2.2,fsspec-2022.11.0,threadpoolctl-3.1.0,simplegeneric-0.8.1,pooch-1.6.0,doit-0.36.0,cloudpickle-2.2.0,pydevtool-0.3.0,rich-13.1.0,rich-click-1.6.0,commonmark-0.9.1,execnet-1.9.0,pytest-xdist-3.1.0")
