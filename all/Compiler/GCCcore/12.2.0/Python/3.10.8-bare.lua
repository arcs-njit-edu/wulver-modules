...
local root = "/apps/easybuild/software/Python/3.10.8-GCCcore-12.2.0-bare"
...
setenv("EBDEVELPYTHON", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Python-3.10.8-bare-easybuild-devel"))
