...
local root = "/apps/easybuild/software/elfutils/0.189-GCCcore-12.2.0"
...
setenv("EBDEVELELFUTILS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-elfutils-0.189-easybuild-devel"))
