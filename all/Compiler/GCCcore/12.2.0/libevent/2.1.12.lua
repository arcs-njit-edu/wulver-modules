...
local root = "/apps/easybuild/software/libevent/2.1.12-GCCcore-12.2.0"
...
setenv("EBDEVELLIBEVENT", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libevent-2.1.12-easybuild-devel"))
