...
local root = "/apps/easybuild/software/gperf/3.1-GCCcore-12.2.0"
...
setenv("EBDEVELGPERF", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-gperf-3.1-easybuild-devel"))
