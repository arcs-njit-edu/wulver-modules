...
local root = "/apps/easybuild/software/libffi/3.4.4-GCCcore-12.2.0"
...
setenv("EBVERSIONLIBFFI", "3.4.4")
setenv("EBDEVELLIBFFI", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libffi-3.4.4-easybuild-devel"))
