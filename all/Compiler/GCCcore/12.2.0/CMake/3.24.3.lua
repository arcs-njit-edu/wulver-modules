...
local root = "/apps/easybuild/software/CMake/3.24.3-GCCcore-12.2.0"
...
setenv("EBDEVELCMAKE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-CMake-3.24.3-easybuild-devel"))
