...
local root = "/apps/easybuild/software/pkgconf/1.9.3-GCCcore-12.2.0"
...
setenv("EBVERSIONPKGCONF", "1.9.3")
setenv("EBDEVELPKGCONF", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-pkgconf-1.9.3-easybuild-devel"))
