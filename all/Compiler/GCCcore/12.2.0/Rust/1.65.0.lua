...
local root = "/apps/easybuild/software/Rust/1.65.0-GCCcore-12.2.0"
...
setenv("EBVERSIONRUST", "1.65.0")
setenv("EBDEVELRUST", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Rust-1.65.0-easybuild-devel"))
