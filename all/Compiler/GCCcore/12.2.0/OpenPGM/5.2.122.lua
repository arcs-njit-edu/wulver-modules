...
local root = "/apps/easybuild/software/OpenPGM/5.2.122-GCCcore-12.2.0"
...
setenv("EBDEVELOPENPGM", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-OpenPGM-5.2.122-easybuild-devel"))
