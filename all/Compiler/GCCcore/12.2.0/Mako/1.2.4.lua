...
local root = "/apps/easybuild/software/Mako/1.2.4-GCCcore-12.2.0"
...
setenv("EBDEVELMAKO", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Mako-1.2.4-easybuild-devel"))
