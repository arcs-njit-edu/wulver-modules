...
local root = "/apps/easybuild/software/libjpeg-turbo/2.1.4-GCCcore-12.2.0"
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libjpeg-turbo-2.1.4-easybuild-devel"))
