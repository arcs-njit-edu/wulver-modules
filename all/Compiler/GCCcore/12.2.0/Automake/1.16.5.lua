...
local root = "/apps/easybuild/software/Automake/1.16.5-GCCcore-12.2.0"
...
setenv("EBDEVELAUTOMAKE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Automake-1.16.5-easybuild-devel"))
