...
local root = "/apps/easybuild/software/binutils/2.39-GCCcore-12.2.0"
...
setenv("EBVERSIONBINUTILS", "2.39")
setenv("EBDEVELBINUTILS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-binutils-2.39-easybuild-devel"))
