...
local root = "/apps/easybuild/software/Yasm/1.3.0-GCCcore-12.2.0"
...
setenv("EBDEVELYASM", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Yasm-1.3.0-easybuild-devel"))
