...
local root = "/apps/easybuild/software/re2c/3.0-GCCcore-12.2.0"
...
setenv("EBVERSIONRE2C", "3.0")
setenv("EBDEVELRE2C", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-re2c-3.0-easybuild-devel"))
