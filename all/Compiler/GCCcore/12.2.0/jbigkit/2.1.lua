...
local root = "/apps/easybuild/software/jbigkit/2.1-GCCcore-12.2.0"
...
setenv("EBDEVELJBIGKIT", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-jbigkit-2.1-easybuild-devel"))
