...
local root = "/apps/easybuild/software/gettext/0.21.1-GCCcore-12.2.0"
...
setenv("EBDEVELGETTEXT", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-gettext-0.21.1-easybuild-devel"))
