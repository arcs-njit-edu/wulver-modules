...
local root = "/apps/easybuild/software/hwloc/2.8.0-GCCcore-12.2.0"
...
setenv("EBVERSIONHWLOC", "2.8.0")
setenv("EBDEVELHWLOC", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-hwloc-2.8.0-easybuild-devel"))
