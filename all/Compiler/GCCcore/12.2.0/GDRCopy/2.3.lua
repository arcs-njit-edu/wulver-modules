...
local root = "/apps/easybuild/software/GDRCopy/2.3-GCCcore-12.2.0"
...
setenv("EBDEVELGDRCOPY", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-GDRCopy-2.3-easybuild-devel"))
