...
local root = "/apps/easybuild/software/PCRE2/10.40-GCCcore-12.2.0"
...
setenv("EBVERSIONPCRE2", "10.40")
setenv("EBDEVELPCRE2", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-PCRE2-10.40-easybuild-devel"))
