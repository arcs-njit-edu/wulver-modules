...
local root = "/apps/easybuild/software/snappy/1.1.9-GCCcore-12.2.0"
...
setenv("EBDEVELSNAPPY", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-snappy-1.1.9-easybuild-devel"))
