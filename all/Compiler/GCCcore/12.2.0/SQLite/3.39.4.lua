...
local root = "/apps/easybuild/software/SQLite/3.39.4-GCCcore-12.2.0"
...
setenv("EBVERSIONSQLITE", "3.39.4")
setenv("EBDEVELSQLITE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-SQLite-3.39.4-easybuild-devel"))
