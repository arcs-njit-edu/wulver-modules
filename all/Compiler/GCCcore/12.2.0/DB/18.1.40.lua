...
local root = "/apps/easybuild/software/DB/18.1.40-GCCcore-12.2.0"
...
setenv("EBDEVELDB", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-DB-18.1.40-easybuild-devel"))
