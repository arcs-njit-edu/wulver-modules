...
local root = "/apps/easybuild/software/nodejs/18.12.1-GCCcore-12.2.0"
...
setenv("EBVERSIONNODEJS", "18.12.1")
setenv("EBDEVELNODEJS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-nodejs-18.12.1-easybuild-devel"))
