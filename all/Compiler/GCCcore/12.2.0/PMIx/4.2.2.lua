...
local root = "/apps/easybuild/software/PMIx/4.2.2-GCCcore-12.2.0"
...
setenv("EBVERSIONPMIX", "4.2.2")
setenv("EBDEVELPMIX", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-PMIx-4.2.2-easybuild-devel"))
