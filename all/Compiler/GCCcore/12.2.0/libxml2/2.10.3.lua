...
local root = "/apps/easybuild/software/libxml2/2.10.3-GCCcore-12.2.0"
...
setenv("EBVERSIONLIBXML2", "2.10.3")
setenv("EBDEVELLIBXML2", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libxml2-2.10.3-easybuild-devel"))
