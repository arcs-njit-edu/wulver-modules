...
local root = "/apps/easybuild/software/libpciaccess/0.17-GCCcore-12.2.0"
...
setenv("EBDEVELLIBPCIACCESS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libpciaccess-0.17-easybuild-devel"))
