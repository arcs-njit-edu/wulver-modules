...
local root = "/apps/easybuild/software/NSPR/4.35-GCCcore-12.2.0"
...
setenv("EBDEVELNSPR", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-NSPR-4.35-easybuild-devel"))
