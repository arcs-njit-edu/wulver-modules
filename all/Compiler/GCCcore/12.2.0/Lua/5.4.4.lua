...
local root = "/apps/easybuild/software/Lua/5.4.4-GCCcore-12.2.0"
...
setenv("EBDEVELLUA", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Lua-5.4.4-easybuild-devel"))

setenv("LUA_DIR", "/apps/easybuild/software/Lua/5.4.4-GCCcore-12.2.0")
