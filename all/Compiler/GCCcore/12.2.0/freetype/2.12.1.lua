...
local root = "/apps/easybuild/software/freetype/2.12.1-GCCcore-12.2.0"
...
setenv("EBDEVELFREETYPE", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-freetype-2.12.1-easybuild-devel"))
