...
local root = "/apps/easybuild/software/libvorbis/1.3.7-GCCcore-12.2.0"
...
setenv("EBDEVELLIBVORBIS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libvorbis-1.3.7-easybuild-devel"))
