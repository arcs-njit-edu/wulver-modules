...
local root = "/apps/easybuild/software/FFmpeg/5.1.2-GCCcore-12.2.0"
...
setenv("EBDEVELFFMPEG", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-FFmpeg-5.1.2-easybuild-devel"))
