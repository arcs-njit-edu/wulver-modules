...
local root = "/apps/easybuild/software/zlib/1.2.12-GCCcore-12.2.0"
...
setenv("EBDEVELZLIB", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-zlib-1.2.12-easybuild-devel"))
