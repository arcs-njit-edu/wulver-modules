...
local root = "/apps/easybuild/software/xprop/1.2.5-GCCcore-12.2.0"
...
setenv("EBDEVELXPROP", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-xprop-1.2.5-easybuild-devel"))
