...
local root = "/apps/easybuild/software/numactl/2.0.16-GCCcore-12.2.0"
...
setenv("EBDEVELNUMACTL", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-numactl-2.0.16-easybuild-devel"))
