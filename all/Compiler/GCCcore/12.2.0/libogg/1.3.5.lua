...
local root = "/apps/easybuild/software/libogg/1.3.5-GCCcore-12.2.0"
...
setenv("EBDEVELLIBOGG", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libogg-1.3.5-easybuild-devel"))
