...
local root = "/apps/easybuild/software/Autotools/20220317-GCCcore-12.2.0"
...
setenv("EBDEVELAUTOTOOLS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-Autotools-20220317-easybuild-devel"))
