...
local root = "/apps/easybuild/software/OpenJPEG/2.5.0-GCCcore-12.2.0"
...
setenv("EBDEVELOPENJPEG", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-OpenJPEG-2.5.0-easybuild-devel"))
