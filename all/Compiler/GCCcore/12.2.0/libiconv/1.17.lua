...
local root = "/apps/easybuild/software/libiconv/1.17-GCCcore-12.2.0"
...
setenv("EBDEVELLIBICONV", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-libiconv-1.17-easybuild-devel"))
