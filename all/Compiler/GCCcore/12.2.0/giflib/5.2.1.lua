...
local root = "/apps/easybuild/software/giflib/5.2.1-GCCcore-12.2.0"
...
setenv("EBDEVELGIFLIB", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-giflib-5.2.1-easybuild-devel"))
