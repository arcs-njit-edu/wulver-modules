...
local root = "/apps/easybuild/software/UCX/1.13.1-GCCcore-12.2.0"
...
setenv("EBVERSIONUCX", "1.13.1")
setenv("EBDEVELUCX", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-UCX-1.13.1-easybuild-devel"))
