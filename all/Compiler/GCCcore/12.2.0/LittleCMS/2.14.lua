...
local root = "/apps/easybuild/software/LittleCMS/2.14-GCCcore-12.2.0"
...
setenv("EBVERSIONLITTLECMS", "2.14")
setenv("EBDEVELLITTLECMS", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-LittleCMS-2.14-easybuild-devel"))
