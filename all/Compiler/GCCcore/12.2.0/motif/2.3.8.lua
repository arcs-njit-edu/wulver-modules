...
local root = "/apps/easybuild/software/motif/2.3.8-GCCcore-12.2.0"
...
setenv("EBDEVELMOTIF", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-motif-2.3.8-easybuild-devel"))
