...
local root = "/apps/easybuild/software/graphite2/1.3.14-GCCcore-12.2.0"
...
setenv("EBDEVELGRAPHITE2", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-graphite2-1.3.14-easybuild-devel"))
