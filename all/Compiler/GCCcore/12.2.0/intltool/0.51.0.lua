...
local root = "/apps/easybuild/software/intltool/0.51.0-GCCcore-12.2.0"
...
setenv("EBDEVELINTLTOOL", pathJoin(root, "easybuild/Compiler-GCCcore-12.2.0-intltool-0.51.0-easybuild-devel"))
