...
local root = "/apps/easybuild/software/UnZip/6.0-GCCcore-13.2.0"
...
setenv("EBDEVELUNZIP", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-UnZip-6.0-easybuild-devel"))
