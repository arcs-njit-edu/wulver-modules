...
local root = "/apps/easybuild/software/hwloc/2.9.2-GCCcore-13.2.0"
...
setenv("EBDEVELHWLOC", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-hwloc-2.9.2-easybuild-devel"))
