...
local root = "/apps/easybuild/software/Rust/1.73.0-GCCcore-13.2.0"
...
setenv("EBVERSIONRUST", "1.73.0")
setenv("EBDEVELRUST", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-Rust-1.73.0-easybuild-devel"))
