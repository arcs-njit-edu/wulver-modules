...
local root = "/apps/easybuild/software/Autotools/20220317-GCCcore-13.2.0"
...
setenv("EBDEVELAUTOTOOLS", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-Autotools-20220317-easybuild-devel"))
