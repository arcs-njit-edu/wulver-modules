...
local root = "/apps/easybuild/software/pkgconf/2.0.3-GCCcore-13.2.0"
...
setenv("EBVERSIONPKGCONF", "2.0.3")
setenv("EBDEVELPKGCONF", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-pkgconf-2.0.3-easybuild-devel"))
