...
local root = "/apps/easybuild/software/libtool/2.4.7-GCCcore-13.2.0"
...
setenv("EBDEVELLIBTOOL", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-libtool-2.4.7-easybuild-devel"))
