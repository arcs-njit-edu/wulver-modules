...
local root = "/apps/easybuild/software/libffi/3.4.4-GCCcore-13.2.0"
...
setenv("EBDEVELLIBFFI", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-libffi-3.4.4-easybuild-devel"))
