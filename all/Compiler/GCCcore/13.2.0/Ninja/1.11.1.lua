...
local root = "/apps/easybuild/software/Ninja/1.11.1-GCCcore-13.2.0"
...
setenv("EBDEVELNINJA", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-Ninja-1.11.1-easybuild-devel"))
