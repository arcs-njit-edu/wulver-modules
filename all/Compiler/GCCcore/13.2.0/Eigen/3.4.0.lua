...
local root = "/apps/easybuild/software/Eigen/3.4.0-GCCcore-13.2.0"
...
setenv("EBDEVELEIGEN", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-Eigen-3.4.0-easybuild-devel"))
