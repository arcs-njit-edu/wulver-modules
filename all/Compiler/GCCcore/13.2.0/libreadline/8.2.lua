...
local root = "/apps/easybuild/software/libreadline/8.2-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBREADLINE", "8.2")
setenv("EBDEVELLIBREADLINE", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-libreadline-8.2-easybuild-devel"))
