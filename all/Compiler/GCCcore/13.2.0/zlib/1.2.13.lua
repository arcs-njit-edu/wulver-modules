...
local root = "/apps/easybuild/software/zlib/1.2.13-GCCcore-13.2.0"
...
setenv("EBDEVELZLIB", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-zlib-1.2.13-easybuild-devel"))
