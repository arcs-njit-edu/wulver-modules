...
local root = "/apps/easybuild/software/expat/2.5.0-GCCcore-13.2.0"
...
setenv("EBDEVELEXPAT", pathJoin(root, "easybuild/Compiler-GCCcore-13.2.0-expat-2.5.0-easybuild-devel"))
