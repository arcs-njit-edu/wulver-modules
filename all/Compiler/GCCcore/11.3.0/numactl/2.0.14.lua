...
local root = "/apps/easybuild/software/numactl/2.0.14-GCCcore-11.3.0"
...
setenv("EBDEVELNUMACTL", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-numactl-2.0.14-easybuild-devel"))
