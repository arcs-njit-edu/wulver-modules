...
local root = "/apps/easybuild/software/binutils/2.38-GCCcore-11.3.0"
...
setenv("EBDEVELBINUTILS", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-binutils-2.38-easybuild-devel"))
