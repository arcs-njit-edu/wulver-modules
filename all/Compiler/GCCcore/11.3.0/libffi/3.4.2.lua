...
local root = "/apps/easybuild/software/libffi/3.4.2-GCCcore-11.3.0"
...
setenv("EBDEVELLIBFFI", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-libffi-3.4.2-easybuild-devel"))
