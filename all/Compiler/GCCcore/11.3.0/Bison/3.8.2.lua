...
local root = "/apps/easybuild/software/Bison/3.8.2-GCCcore-11.3.0"
...
setenv("EBDEVELBISON", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-Bison-3.8.2-easybuild-devel"))
