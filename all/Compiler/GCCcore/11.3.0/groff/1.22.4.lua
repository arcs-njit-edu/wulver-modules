...
local root = "/apps/easybuild/software/groff/1.22.4-GCCcore-11.3.0"
...
setenv("EBDEVELGROFF", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-groff-1.22.4-easybuild-devel"))
