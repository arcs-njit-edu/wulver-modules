...
local root = "/apps/easybuild/software/hypothesis/6.46.7-GCCcore-11.3.0"
...
setenv("EBVERSIONHYPOTHESIS", "6.46.7")
setenv("EBDEVELHYPOTHESIS", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-hypothesis-6.46.7-easybuild-devel"))
