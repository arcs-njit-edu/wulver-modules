...
local root = "/apps/easybuild/software/Rust/1.60.0-GCCcore-11.3.0"
...
setenv("EBVERSIONRUST", "1.60.0")
setenv("EBDEVELRUST", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-Rust-1.60.0-easybuild-devel"))
