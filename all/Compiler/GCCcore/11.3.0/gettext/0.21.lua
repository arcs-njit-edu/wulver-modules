...
local root = "/apps/easybuild/software/gettext/0.21-GCCcore-11.3.0"
...
setenv("EBDEVELGETTEXT", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-gettext-0.21-easybuild-devel"))
