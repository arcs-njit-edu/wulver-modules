...
local root = "/apps/easybuild/software/libreadline/8.1.2-GCCcore-11.3.0"
...
setenv("EBVERSIONLIBREADLINE", "8.1.2")
setenv("EBDEVELLIBREADLINE", pathJoin(root, "easybuild/Compiler-GCCcore-11.3.0-libreadline-8.1.2-easybuild-devel"))
