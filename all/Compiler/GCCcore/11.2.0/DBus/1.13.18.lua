...
local root = "/apps/easybuild/software/DBus/1.13.18-GCCcore-11.2.0"
...
setenv("EBDEVELDBUS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-DBus-1.13.18-easybuild-devel"))
