...
local root = "/apps/easybuild/software/libarchive/3.5.1-GCCcore-11.2.0"
...
setenv("EBDEVELLIBARCHIVE", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libarchive-3.5.1-easybuild-devel"))
