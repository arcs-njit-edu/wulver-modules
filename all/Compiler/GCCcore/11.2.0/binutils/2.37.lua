...
local root = "/apps/easybuild/software/binutils/2.37-GCCcore-11.2.0"
...
setenv("EBDEVELBINUTILS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-binutils-2.37-easybuild-devel"))
