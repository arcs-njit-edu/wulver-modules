...
local root = "/apps/easybuild/software/NCCL/2.10.3-GCCcore-11.2.0-CUDA-11.4.1"
...
setenv("EBDEVELNCCL", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-NCCL-2.10.3-CUDA-11.4.1-easybuild-devel"))
