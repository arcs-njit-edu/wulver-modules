...
local root = "/apps/easybuild/software/Brotli/1.0.9-GCCcore-11.2.0"
...
setenv("EBDEVELBROTLI", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-Brotli-1.0.9-easybuild-devel"))
