...
local root = "/apps/easybuild/software/util-linux/2.37-GCCcore-11.2.0"
...
setenv("EBVERSIONUTILMINLINUX", "2.37")
setenv("EBDEVELUTILMINLINUX", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-util-linux-2.37-easybuild-devel"))
