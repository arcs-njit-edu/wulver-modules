...
local root = "/apps/easybuild/software/zlib/1.2.11-GCCcore-11.2.0"
...
setenv("EBDEVELZLIB", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-zlib-1.2.11-easybuild-devel"))
