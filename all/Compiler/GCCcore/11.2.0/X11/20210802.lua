...
local root = "/apps/easybuild/software/X11/20210802-GCCcore-11.2.0"
...
setenv("EBVERSIONX11", "20210802")
setenv("EBDEVELX11", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-X11-20210802-easybuild-devel"))
