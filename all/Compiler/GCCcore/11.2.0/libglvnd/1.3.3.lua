...
local root = "/apps/easybuild/software/libglvnd/1.3.3-GCCcore-11.2.0"
...
setenv("EBDEVELLIBGLVND", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libglvnd-1.3.3-easybuild-devel"))
