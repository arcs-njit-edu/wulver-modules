...
local root = "/apps/easybuild/software/FLAC/1.3.3-GCCcore-11.2.0"
...
setenv("EBDEVELFLAC", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-FLAC-1.3.3-easybuild-devel"))
