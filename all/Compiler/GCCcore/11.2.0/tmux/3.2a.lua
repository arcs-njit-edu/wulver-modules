...
local root = "/apps/easybuild/software/tmux/3.2a-GCCcore-11.2.0"
...
setenv("EBDEVELTMUX", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-tmux-3.2a-easybuild-devel"))
