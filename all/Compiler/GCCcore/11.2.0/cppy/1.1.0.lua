...
local root = "/apps/easybuild/software/cppy/1.1.0-GCCcore-11.2.0"
...
setenv("EBDEVELCPPY", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-cppy-1.1.0-easybuild-devel"))
