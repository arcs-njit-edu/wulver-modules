...
local root = "/apps/easybuild/software/METIS/5.1.0-GCCcore-11.2.0"
...
setenv("EBDEVELMETIS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-METIS-5.1.0-easybuild-devel"))
