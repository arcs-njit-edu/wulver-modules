...
local root = "/apps/easybuild/software/libsndfile/1.0.31-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBSNDFILE", "1.0.31")
setenv("EBDEVELLIBSNDFILE", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libsndfile-1.0.31-easybuild-devel"))
