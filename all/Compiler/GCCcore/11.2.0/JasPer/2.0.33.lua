...
local root = "/apps/easybuild/software/JasPer/2.0.33-GCCcore-11.2.0"
...
setenv("EBVERSIONJASPER", "2.0.33")
setenv("EBDEVELJASPER", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-JasPer-2.0.33-easybuild-devel"))
