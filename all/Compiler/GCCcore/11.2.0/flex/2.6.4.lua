...
local root = "/apps/easybuild/software/flex/2.6.4-GCCcore-11.2.0"
...
setenv("EBDEVELFLEX", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-flex-2.6.4-easybuild-devel"))
