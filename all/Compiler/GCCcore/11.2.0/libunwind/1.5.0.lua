...
local root = "/apps/easybuild/software/libunwind/1.5.0-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBUNWIND", "1.5.0")
setenv("EBDEVELLIBUNWIND", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libunwind-1.5.0-easybuild-devel"))
