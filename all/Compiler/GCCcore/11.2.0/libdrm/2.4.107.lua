...
local root = "/apps/easybuild/software/libdrm/2.4.107-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBDRM", "2.4.107")
setenv("EBDEVELLIBDRM", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libdrm-2.4.107-easybuild-devel"))
