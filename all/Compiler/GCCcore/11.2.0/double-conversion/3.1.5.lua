...
local root = "/apps/easybuild/software/double-conversion/3.1.5-GCCcore-11.2.0"
...
setenv("EBDEVELDOUBLEMINCONVERSION", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-double-conversion-3.1.5-easybuild-devel"))
