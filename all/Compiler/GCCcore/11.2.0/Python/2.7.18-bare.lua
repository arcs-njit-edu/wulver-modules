...
local root = "/apps/easybuild/software/Python/2.7.18-GCCcore-11.2.0-bare"
...
setenv("EBDEVELPYTHON", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-Python-2.7.18-bare-easybuild-devel"))
