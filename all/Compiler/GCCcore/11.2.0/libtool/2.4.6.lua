...
local root = "/apps/easybuild/software/libtool/2.4.6-GCCcore-11.2.0"
...
setenv("EBDEVELLIBTOOL", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libtool-2.4.6-easybuild-devel"))
