...
local root = "/apps/easybuild/software/LibTIFF/4.3.0-GCCcore-11.2.0"
...
setenv("EBDEVELLIBTIFF", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-LibTIFF-4.3.0-easybuild-devel"))
