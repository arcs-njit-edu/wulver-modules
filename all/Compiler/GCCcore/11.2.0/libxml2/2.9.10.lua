...
local root = "/apps/easybuild/software/libxml2/2.9.10-GCCcore-11.2.0"
...
setenv("EBDEVELLIBXML2", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libxml2-2.9.10-easybuild-devel"))
