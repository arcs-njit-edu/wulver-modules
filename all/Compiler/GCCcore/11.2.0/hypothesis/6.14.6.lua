...
local root = "/apps/easybuild/software/hypothesis/6.14.6-GCCcore-11.2.0"
...
setenv("EBDEVELHYPOTHESIS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-hypothesis-6.14.6-easybuild-devel"))
