...
local root = "/apps/easybuild/software/CMake/3.22.1-GCCcore-11.2.0"
...
setenv("EBDEVELCMAKE", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-CMake-3.22.1-easybuild-devel"))
