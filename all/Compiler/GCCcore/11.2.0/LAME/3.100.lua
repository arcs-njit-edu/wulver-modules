...
local root = "/apps/easybuild/software/LAME/3.100-GCCcore-11.2.0"
...
setenv("EBDEVELLAME", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-LAME-3.100-easybuild-devel"))
