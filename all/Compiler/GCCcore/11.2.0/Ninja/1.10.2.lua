...
local root = "/apps/easybuild/software/Ninja/1.10.2-GCCcore-11.2.0"
...
setenv("EBDEVELNINJA", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-Ninja-1.10.2-easybuild-devel"))
