...
local root = "/apps/easybuild/software/SDL2/2.0.20-GCCcore-11.2.0"
...
setenv("EBDEVELSDL2", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-SDL2-2.0.20-easybuild-devel"))
