...
local root = "/apps/easybuild/software/libpng/1.6.37-GCCcore-11.2.0"
...
setenv("EBDEVELLIBPNG", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libpng-1.6.37-easybuild-devel"))
