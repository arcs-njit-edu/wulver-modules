...
local root = "/apps/easybuild/software/lz4/1.9.3-GCCcore-11.2.0"
...
setenv("EBDEVELLZ4", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-lz4-1.9.3-easybuild-devel"))
