...
local root = "/apps/easybuild/software/zstd/1.5.0-GCCcore-11.2.0"
...
setenv("EBVERSIONZSTD", "1.5.0")
setenv("EBDEVELZSTD", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-zstd-1.5.0-easybuild-devel"))
