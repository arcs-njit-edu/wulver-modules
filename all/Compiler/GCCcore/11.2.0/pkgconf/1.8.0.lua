...
local root = "/apps/easybuild/software/pkgconf/1.8.0-GCCcore-11.2.0"
...
setenv("EBDEVELPKGCONF", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-pkgconf-1.8.0-easybuild-devel"))
