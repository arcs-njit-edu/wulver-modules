...
local root = "/apps/easybuild/software/libiconv/1.16-GCCcore-11.2.0"
...
setenv("EBDEVELLIBICONV", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libiconv-1.16-easybuild-devel"))
