...
local root = "/apps/easybuild/software/NSPR/4.32-GCCcore-11.2.0"
...
setenv("EBVERSIONNSPR", "4.32")
setenv("EBDEVELNSPR", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-NSPR-4.32-easybuild-devel"))
