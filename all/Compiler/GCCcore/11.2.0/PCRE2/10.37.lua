...
local root = "/apps/easybuild/software/PCRE2/10.37-GCCcore-11.2.0"
...
setenv("EBVERSIONPCRE2", "10.37")
setenv("EBDEVELPCRE2", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-PCRE2-10.37-easybuild-devel"))
