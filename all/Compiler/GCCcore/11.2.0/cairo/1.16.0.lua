...
local root = "/apps/easybuild/software/cairo/1.16.0-GCCcore-11.2.0"
...
setenv("EBDEVELCAIRO", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-cairo-1.16.0-easybuild-devel"))
