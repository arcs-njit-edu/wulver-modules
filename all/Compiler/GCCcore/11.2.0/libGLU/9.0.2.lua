...
local root = "/apps/easybuild/software/libGLU/9.0.2-GCCcore-11.2.0"
...
setenv("EBDEVELLIBGLU", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libGLU-9.0.2-easybuild-devel"))
