...
local root = "/apps/easybuild/software/Szip/2.1.1-GCCcore-11.2.0"
...
setenv("EBDEVELSZIP", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-Szip-2.1.1-easybuild-devel"))
