...
local root = "/apps/easybuild/software/git/2.33.1-GCCcore-11.2.0-nodocs"
...
setenv("EBVERSIONGIT", "2.33.1")
setenv("EBDEVELGIT", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-git-2.33.1-nodocs-easybuild-devel"))
