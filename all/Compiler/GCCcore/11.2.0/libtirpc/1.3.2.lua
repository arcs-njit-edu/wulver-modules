...
local root = "/apps/easybuild/software/libtirpc/1.3.2-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBTIRPC", "1.3.2")
setenv("EBDEVELLIBTIRPC", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libtirpc-1.3.2-easybuild-devel"))
