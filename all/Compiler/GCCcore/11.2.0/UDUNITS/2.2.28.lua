...
local root = "/apps/easybuild/software/UDUNITS/2.2.28-GCCcore-11.2.0"
...
setenv("EBDEVELUDUNITS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-UDUNITS-2.2.28-easybuild-devel"))
