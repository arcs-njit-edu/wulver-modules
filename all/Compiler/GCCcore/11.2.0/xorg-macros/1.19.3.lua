...
local root = "/apps/easybuild/software/xorg-macros/1.19.3-GCCcore-11.2.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-xorg-macros-1.19.3-easybuild-devel"))
