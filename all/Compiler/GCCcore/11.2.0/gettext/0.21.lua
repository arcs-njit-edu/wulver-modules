...
local root = "/apps/easybuild/software/gettext/0.21-GCCcore-11.2.0"
...
setenv("EBDEVELGETTEXT", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-gettext-0.21-easybuild-devel"))
