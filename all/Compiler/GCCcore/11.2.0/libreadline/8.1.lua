...
local root = "/apps/easybuild/software/libreadline/8.1-GCCcore-11.2.0"
...
setenv("EBDEVELLIBREADLINE", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-libreadline-8.1-easybuild-devel"))
