...
local root = "/apps/easybuild/software/NLopt/2.7.0-GCCcore-11.2.0"
...
setenv("EBVERSIONNLOPT", "2.7.0")
setenv("EBDEVELNLOPT", pathJoin(root, "easybuild/Compiler-GCCcore-11.2.0-NLopt-2.7.0-easybuild-devel"))
