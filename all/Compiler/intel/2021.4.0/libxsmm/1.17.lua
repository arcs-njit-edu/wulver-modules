...
local root = "/apps/easybuild/software/libxsmm/1.17-intel-compilers-2021.4.0"
...
setenv("EBDEVELLIBXSMM", pathJoin(root, "easybuild/Compiler-intel-2021.4.0-libxsmm-1.17-easybuild-devel"))
