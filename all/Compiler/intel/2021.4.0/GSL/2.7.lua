...
local root = "/apps/easybuild/software/GSL/2.7-intel-compilers-2021.4.0"
...
setenv("EBDEVELGSL", pathJoin(root, "easybuild/Compiler-intel-2021.4.0-GSL-2.7-easybuild-devel"))
