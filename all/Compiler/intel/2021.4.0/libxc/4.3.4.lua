...
local root = "/apps/easybuild/software/libxc/4.3.4-intel-compilers-2021.4.0"
...
setenv("EBVERSIONLIBXC", "4.3.4")
setenv("EBDEVELLIBXC", pathJoin(root, "easybuild/Compiler-intel-2021.4.0-libxc-4.3.4-easybuild-devel"))
