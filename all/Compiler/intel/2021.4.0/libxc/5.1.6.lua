...
local root = "/apps/easybuild/software/libxc/5.1.6-intel-compilers-2021.4.0"
...
setenv("EBVERSIONLIBXC", "5.1.6")
setenv("EBDEVELLIBXC", pathJoin(root, "easybuild/Compiler-intel-2021.4.0-libxc-5.1.6-easybuild-devel"))
