...
local root = "/apps/easybuild/software/Boost/1.77.0-intel-compilers-2021.4.0"
...
setenv("EBVERSIONBOOST", "1.77.0")
setenv("EBDEVELBOOST", pathJoin(root, "easybuild/Compiler-intel-2021.4.0-Boost-1.77.0-easybuild-devel"))

setenv("BOOST_ROOT", "/apps/easybuild/software/Boost/1.77.0-intel-compilers-2021.4.0")
