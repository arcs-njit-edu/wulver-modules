...
local root = "/apps/easybuild/software/libxc/6.1.0-intel-compilers-2022.2.1"
...
setenv("EBDEVELLIBXC", pathJoin(root, "easybuild/Compiler-intel-2022.2.1-libxc-6.1.0-easybuild-devel"))
