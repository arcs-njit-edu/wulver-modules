...
local root = "/apps/easybuild/software/libxc/5.2.3-intel-compilers-2022.2.1"
...
setenv("EBDEVELLIBXC", pathJoin(root, "easybuild/Compiler-intel-2022.2.1-libxc-5.2.3-easybuild-devel"))
